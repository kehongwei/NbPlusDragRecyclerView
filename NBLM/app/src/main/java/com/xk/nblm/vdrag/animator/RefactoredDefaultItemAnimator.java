...
package com.xk.nblm.vdrag.animator;
...
import com.xk.nblm.vdrag.animator.impl.AddAnimationInfo;
import com.xk.nblm.vdrag.animator.impl.ChangeAnimationInfo;
import com.xk.nblm.vdrag.animator.impl.ItemAddAnimationManager;
import com.xk.nblm.vdrag.animator.impl.ItemChangeAnimationManager;
import com.xk.nblm.vdrag.animator.impl.ItemMoveAnimationManager;
import com.xk.nblm.vdrag.animator.impl.ItemRemoveAnimationManager;
import com.xk.nblm.vdrag.animator.impl.MoveAnimationInfo;
import com.xk.nblm.vdrag.animator.impl.RemoveAnimationInfo;
...
public class RefactoredDefaultItemAnimator extends GeneralItemAnimator {
    ...
    protected static class DefaultItemMoveAnimationManager extends ItemMoveAnimationManager {
        ...
        protected void onCreateAnimation(@NonNull MoveAnimationInfo info) {
            ...
            Log.i("khw",info.fromX +"  "+info.toX+"  "+info.fromY+"   "+info.toY);
