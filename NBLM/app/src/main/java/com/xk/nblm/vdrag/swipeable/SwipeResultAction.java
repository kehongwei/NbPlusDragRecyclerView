...
public abstract class SwipeResultAction {
    ...
    /**
     * This method is called immediately after returning from the {@link com.xk.nblm.vdrag.swipeable.SwipeableItemAdapter#onSwipeItem(RecyclerView.ViewHolder, int, int)} method.
