...
package com.xk.nblm.vdrag.swipeable;
...
import com.xk.nblm.vdrag.swipeable.annotation.SwipeableItemAfterReactions;
...
public interface SwipeableItemViewHolder {
     ...
     *              - {@link com.xk.nblm.vdrag.swipeable.SwipeableItemConstants#STATE_FLAG_SWIPING}
     *              - {@link com.xk.nblm.vdrag.swipeable.SwipeableItemConstants#STATE_FLAG_IS_ACTIVE}
     *              - {@link com.xk.nblm.vdrag.swipeable.SwipeableItemConstants#STATE_FLAG_IS_UPDATED}
     * @see #getSwipeState()
     */
     ...
     * This method can be used inside of the {@link android.support.v7.widget.RecyclerView.Adapter#onBindViewHolder(RecyclerView.ViewHolder, int)}.
     *
     ...
     *               - {@link com.xk.nblm.vdrag.swipeable.RecyclerViewSwipeManager#RESULT_NONE}
     *               - {@link com.xk.nblm.vdrag.swipeable.RecyclerViewSwipeManager#RESULT_SWIPED_LEFT}
     *               - {@link com.xk.nblm.vdrag.swipeable.RecyclerViewSwipeManager#RESULT_SWIPED_UP}
     *               - {@link com.xk.nblm.vdrag.swipeable.RecyclerViewSwipeManager#RESULT_SWIPED_RIGHT}
     *               - {@link com.xk.nblm.vdrag.swipeable.RecyclerViewSwipeManager#RESULT_SWIPED_DOWN}
     *               - {@link com.xk.nblm.vdrag.swipeable.RecyclerViewSwipeManager#RESULT_CANCELED}
     */
     ...
     *                 - {@link com.xk.nblm.vdrag.swipeable.RecyclerViewSwipeManager#AFTER_SWIPE_REACTION_DEFAULT}
     *                 - {@link com.xk.nblm.vdrag.swipeable.RecyclerViewSwipeManager#AFTER_SWIPE_REACTION_MOVE_TO_ORIGIN}
     *                 - {@link com.xk.nblm.vdrag.swipeable.RecyclerViewSwipeManager#AFTER_SWIPE_REACTION_REMOVE_ITEM}
     *                 - {@link com.xk.nblm.vdrag.swipeable.RecyclerViewSwipeManager#AFTER_SWIPE_REACTION_MOVE_TO_SWIPED_DIRECTION}
     *                 - {@link com.xk.nblm.vdrag.swipeable.RecyclerViewSwipeManager#AFTER_SWIPE_REACTION_DO_NOTHING}
     */
     ...
     *               - {@link com.xk.nblm.vdrag.swipeable.RecyclerViewSwipeManager#OUTSIDE_OF_THE_WINDOW_LEFT}
     *               - {@link com.xk.nblm.vdrag.swipeable.RecyclerViewSwipeManager#OUTSIDE_OF_THE_WINDOW_RIGHT}
     */
     ...
     * @param amount Item swipe amount. Generally the range is [-1.0 .. 1.0] if the proportional amount mode is enabled, otherwise distance in pixels.
     *               In additionally, these special values can also be accepted;
     *               - {@link com.xk.nblm.vdrag.swipeable.RecyclerViewSwipeManager#OUTSIDE_OF_THE_WINDOW_TOP}
     *               - {@link com.xk.nblm.vdrag.swipeable.RecyclerViewSwipeManager#OUTSIDE_OF_THE_WINDOW_BOTTOM}
     */
