...
import com.xk.nblm.vdrag.adapter.SimpleWrapperAdapter ;
import com.xk.nblm.vdrag.swipeable.RecyclerViewSwipeManager;
import com.xk.nblm.vdrag.swipeable.SwipeableItemAdapter;
import com.xk.nblm.vdrag.swipeable.SwipeResultAction;
import com.xk.nblm.vdrag.swipeable.SwipeResultActionDefault;
...
class DraggableItemWrapperAdapter<VH extends RecyclerView.ViewHolder> extends SimpleWrapperAdapter<VH> implements SwipeableItemAdapter<VH> {
    ...
    /*package*/ void moveItem(int fromPosition, int toPosition, int layoutType) {
        ...
        final int origFromPosition = convertToOriginalPosition(fromPosition, mDraggingItemInitialPosition, mDraggingItemCurrentPosition, mItemMoveMode);
        ...
        // notify to observers
        Log.i("khw","=====xxxxx====="+origFromPosition+"   "+ mDraggingItemCurrentPosition);
